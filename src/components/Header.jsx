    ...
    <header className="main-header flex items-center justify-between p-5">
      <div className="left">
        <img
          ...
          width={100}
          height={100}
          onClick={handleClickScroll5}
        />
      </div>
      <div className="middle min-[290px]:hidden md:block">
        <nav className="flex items-center justify-center gap-5">
          <p className="text-2xl dark:text-white" onClick={handleClickScroll1}>
            ABOUT US
          </p>
          <p className="text-2xl dark:text-white" onClick={handleClickScroll2}>
            SERVICES
          </p>
          <p className="text-2xl dark:text-white" onClick={handleClickScroll6}>
            OUR TEAM
          </p>
          <p className="text-2xl dark:text-white" onClick={handleClickScroll7}>
            OUR PARTNERS
          </p>
          <p className="text-2xl dark:text-white" onClick={handleClickScroll3}>
            APPOINTMENT
          </p>
          <p className="text-2xl dark:text-white" onClick={handleClickScroll4}>
            SUPPORT
          </p>
        </nav>
      </div>
      ...
      <div className="right">
        <label className="swap swap-rotate" htmlFor="theme">
          ...
          {/* moon icon */}
          <svg
            className="w-10 h-10 fill-[#1e1e1e] swap-off"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
